...
export default function Contact() {
  return (
    <div className="flex flex-col items-center p-4 md:p-8">
      ...
      <div className="w-full md:w-3/4 lg:w-2/3 flex flex-col md:flex-row p-6 rounded-lg">
        ...
        <div className="w-full md:w-1/2">
          ...
          <form className="flex flex-col space-y-4">
            ...
            <button
              type="submit"
              className="bg-[#029FAE] px-8 py-2 mt-6 text-xl text-white rounded-md hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            >
              Submit
            </button>
          </form>
      ...
      <div className="h-[270] w-full flex flex-wrap items-center mt-16 justify-evenly bg-[#F4F4F4] mx-4 md:mx-8 py-10">
        <Image 
          src="/first.png"
          alt="Service 1"
          width={1000}
